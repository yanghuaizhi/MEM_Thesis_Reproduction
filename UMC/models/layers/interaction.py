...
from models.layers.core import Conv2dSame
from models.sequence import KMaxPooling
...
Tongwen](https://arxiv.org/pdf/1905.09433.pdf)
    ...
    def __init__(self, filed_size, reduction_ratio=3, device='cpu'):
...
Tongwen](https://arxiv.org/pdf/1905.09433.pdf)
    ...
    def __init__(self, filed_size, embedding_size, bilinear_type="interaction", device='cpu'):
...
class CIN(nn.Module):
    ...
    def __init__(self, field_size, layer_size=(128, 128), activation='relu', split_half=True, l2_reg=1e-5,
                 device='cpu'):
...
class AFMLayer(nn.Module):
    ...
    def __init__(self, in_features, attention_factor=4, l2_reg_w=0, dropout_rate=0, device='cpu'):
